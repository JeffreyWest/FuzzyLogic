...
AU_UAV_ROS::PlanePose* thisUAV;
AU_UAV_ROS::PlanePose* thatUAV;
...
AU_UAV_ROS::fuzzyParams getFuzzyParams(AU_UAV_ROS::PlanePose* currentUAV, AU_UAV_ROS::PlanePose* closestUAV)
{
    ...
    fuzzyParams.ourBearingAngle = getBearingAngle(*currentUAV, *closestUAV);
    fuzzyParams.theirBearingAngle = getBearingAngle(*closestUAV, *currentUAV);
...
double getBearingAngle(AU_UAV_ROS::PlanePose first, AU_UAV_ROS::PlanePose second)
{
    ...
    bearingAngle = manipulateAngle(bearingAngle);
...
//The rest of the functions were originally meant to be used in the first fuzzy logic controller, but were not implemented in the final build:
